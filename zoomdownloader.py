...
def get_recordings():
    ...
    zoom_user_id = zoom_user_id_combobox.get()
    meetings.clear()
...
zoom_user_id_combobox = ttk.Combobox(root, values=["depdir.lrn@bpjsketenagakerjaan.go.id", 
                                                   "daro.aji@bpjsketenagakerjaan.go.id", 
                                                   "jaenal.aripin@bpjsketenagakerjaan.go.id",
                                                    "agung.yuniarto@bpjsketenagakerjaan.go.id",
                                                    "amanda.resy@bpjsketenagakerjaan.go.id",
                                                    "athur.buono@bpjsketenagakerjaan.go.id",
                                                    "yoga.satrianto@bpjsketenagakerjaan.go.id",
                                                    "yulius.ardi@bpjsketenagakerjaan.go.id",
                                                    "lucky.mauryan@bpjsketenagakerjaan.go.id",
                                                    "martina.sitorus@bpjsketenagakerjaan.go.id",
                                                    "maulana.sidik@bpjsketenagakerjaan.go.id",
                                                    "mega.dikta@bpjsketenagakerjaan.go.id",
                                                    "nazil.miftahuddin@bpjsketenagakerjaan.go.id",
                                                    "puspita.apsari@bpjsketenagakerjaan.go.id",
                                                    "satriyo.adi@bpjsketenagakerjaan.go.id",
                                                    ])
zoom_user_id_combobox.grid(row=0, column=1, padx=5, pady=5, sticky="we")
...
start_date_cal.grid(row=1, column=1, padx=5, pady=5, sticky="w")
...
end_date_cal.grid(row=2, column=1, padx=5, pady=5, sticky="w")
